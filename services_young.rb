...
class ConnectionTest
  ...
  def internet_connection
    begin
      ...
      p 'Error: ' + e.to_s + ' Time: ' + Time.now + ' platform: ' + @platform['platform']
    ensure
      sleep 10
      internet_connection
	  end
  ...
  def test_connection url
    begin
      ...
      p ' Offline: ' + @platform['platform'].to_s + ' Time: ' + Time.now + ' error: ' + e.to_s
    end
  end
